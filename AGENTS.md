...
- Requests **without** `X-OpenRouter-Api-Key` use **`OPENROUTER_DEMO_MODEL`** (default `openai/gpt-oss-120b`) and a neuroscientist-educator system prompt; BYOK requests use **`OPENROUTER_MODEL`**.
