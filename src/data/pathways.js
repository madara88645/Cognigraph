    ...
    "steps": [
      {
        ...
        "evidence_tier": "human_direct",
        "tier_reason": "Human C1 visual evoked potential; macaque data only backs the conduction estimate."
      },
      {
        "region_ids": [
          "v4"
        ...
        "evidence_tier": "animal_inferred",
        "tier_reason": "Macaque V4 single-unit timing; the human latency is inferred, not measured."
      },
      {
        "region_ids": [
          "ffa"
        ...
        "evidence_tier": "human_direct",
        "tier_reason": "Human N170 ERP with simultaneous fMRI-EEG source work (Gao et al., 2019)."
      },
      {
        "region_ids": [
          "hippocampus",
        ...
        "tier_reason": "Human fMRI locates the stage, but the 300 ms figure is estimated."
      },
      {
        "region_ids": [
          "vmpfc_ofc",
        ...
        "evidence_tier": "estimated",
        "tier_reason": "Human fMRI and EEG support the stage; its timing is the least time-locked."
      }
    ],
    ...
    "steps": [
      {
        ...
        "evidence_tier": "estimated",
        "tier_reason": "Human fMRI shows the search; the 200 ms onset is an estimate."
      },
      {
        "region_ids": [
          "hippocampus"
        ...
        "evidence_tier": "estimated",
        "tier_reason": "Computational models and lesion work; the human timing is inferred, not measured."
      },
      {
        "region_ids": [
          "dlpfc",
        ...
        "approx_ms": 450,
        "what_happens": "Prefrontal cortex produces a familiarity signal ('I know this person') that can arrive before the hippocampus has finished full recollection.",
        "why_it_matters": "Familiarity and full recollection are dissociable memory processes with different reliability.",
        "evidence_or_method": "Frontal/early old-new ERP effect (the FN400) associated with familiarity, roughly 300-500ms post-cue (Rugg & Curran, 2007 review); the frontal scalp signal is why this step names prefrontal cortex rather than a subcortical relay.",
        "evidence_tier": "human_direct",
        "tier_reason": "Human frontal old/new ERP, 300-500 ms (Rugg & Curran, 2007)."
      },
      {
        "region_ids": [
          "ppc"
        ...
        "evidence_tier": "human_direct",
        "tier_reason": "Human parietal old/new ERP, 500-800 ms (Rugg & Curran, 2007)."
      },
      {
        "region_ids": [
          "broca",
        ...
        "evidence_tier": "estimated",
        "tier_reason": "Human tip-of-the-tongue work names the stage; 800 ms is an estimate."
      }
    ],
    ...
    "steps": [
      {
        ...
        "evidence_tier": "human_direct",
        "tier_reason": "Human MEG (Luo et al., 2007); deep-source localisation is contested."
      },
      {
        "region_ids": [
          "amygdala"
        ...
        "evidence_tier": "human_direct",
        "tier_reason": "Human intracranial amygdala recordings, 74-88 ms (Mendez-Bertolo et al., 2016)."
      },
      {
        "region_ids": [
          "hypothalamus"
        ...
        "evidence_tier": "animal_inferred",
        "tier_reason": "Amygdala-hypothalamic fear circuitry from animal lesion and stimulation work."
      },
      {
        "region_ids": [
          "v1",
        ...
        "evidence_tier": "estimated",
        "tier_reason": "Generic human object-recognition ERP window, not a measurement of this scene."
      },
      {
        "region_ids": [
          "vmpfc_ofc",
        ...
        "evidence_tier": "estimated",
        "tier_reason": "Human fMRI supports the regulation; its millisecond timing is not established."
      }
    ],
    ...
    "steps": [
      {
        ...
        "evidence_tier": "estimated",
        "tier_reason": "Standard visual latency plus parietal attention, combined rather than measured together."
      },
      {
        "region_ids": [
          "vmpfc_ofc"
        ...
        "evidence_tier": "animal_inferred",
        "tier_reason": "Macaque OFC single units for value; human fMRI carries no timing."
      },
      {
        "region_ids": [
          "dlpfc",
        ...
        "evidence_tier": "human_direct",
        "tier_reason": "Human P300 latency tracks decision difficulty; ACC conflict model (Botvinick, 2001)."
      },
      {
        "region_ids": [
          "striatum",
        ...
        "evidence_tier": "human_direct",
        "tier_reason": "Human centro-parietal positivity tracks evidence accumulation (O'Connell et al., 2012)."
      },
      {
        "region_ids": [
          "m1"
        ...
        "evidence_tier": "estimated",
        "tier_reason": "Human reaction-time and motor-potential work, but nothing pins 500 ms."
      }
    ],
    ...
    "steps": [
      {
        ...
        "evidence_tier": "estimated",
        "tier_reason": "Standard V1 evoked-potential latency, quoted generically rather than measured for reading."
      },
      {
        "region_ids": [
          "ffa"
        ...
        "evidence_tier": "human_direct",
        "tier_reason": "Human word-form responses in a 150-200 ms window (Dehaene & Cohen, 2011)."
      },
      {
        "region_ids": [
          "wernicke"
        ...
        "evidence_tier": "human_direct",
        "tier_reason": "Human N400 ERP peaking near 400 ms (Kutas & Hillyard, 1980)."
      },
      {
        "region_ids": [
          "broca"
        ...
        "evidence_tier": "human_direct",
        "tier_reason": "Human P600 syntactic ERP plus classic aphasia lesion-symptom mapping."
      },
      {
        "region_ids": [
          "m1"
        ...
        "evidence_tier": "estimated",
        "tier_reason": "Standard articulation timing; no measurement backs this step's 600 ms."
      }
    ],
    ...
    "steps": [
      {
        ...
        "evidence_tier": "estimated",
        "tier_reason": "Schematic: stage order from human motor-learning models, so the number is not time."
      },
      {
        "region_ids": [
          "cerebellum"
        ...
        "evidence_tier": "estimated",
        "tier_reason": "Schematic: cerebellar forward-model theory, an account rather than a measured latency."
      },
      {
        "region_ids": [
          "striatum",
        ...
        "evidence_tier": "estimated",
        "tier_reason": "Schematic: the associative-to-sensorimotor shift comes mainly from rodent recordings."
      },
      {
        "region_ids": [
          "substantia_nigra",
        ...
        "evidence_tier": "estimated",
        "tier_reason": "Schematic: dopamine reinforcement signals established in monkey and rodent recordings."
      },
      {
        "region_ids": [
          "m1",
        ...
        "evidence_tier": "estimated",
        "tier_reason": "Schematic: human amnesia cases show retention, but give no timing at all."
      }
    ],
    ...
    "steps": [
      {
        ...
        "evidence_tier": "estimated",
        "tier_reason": "Standard early visual latency, quoted generically rather than measured while driving."
      },
      {
        "region_ids": [
          "mt_v5"
        ...
        "evidence_tier": "animal_inferred",
        "tier_reason": "Primate MT electrophysiology, 80-120 ms; the human latency is inferred."
      },
      {
        "region_ids": [
          "ppc"
        ...
        "evidence_tier": "human_direct",
        "tier_reason": "Human N2pc ERP, 200-250 ms (Luck & Hillyard, 1994; Eimer, 1996)."
      },
      {
        "region_ids": [
          "locus_coeruleus"
        ...
        "evidence_tier": "animal_inferred",
        "tier_reason": "Locus coeruleus gain theory rests largely on animal electrophysiology (Aston-Jones & Cohen, 2005)."
      },
      {
        "region_ids": [
          "acc",
        ...
        "evidence_tier": "estimated",
        "tier_reason": "Conflict model plus simulator reaction times; this step's 350 ms is estimated."
      }
    ],
    ...
    "steps": [
      {
        ...
        "evidence_tier": "estimated",
        "tier_reason": "Schematic: complementary-learning-systems theory, a framework rather than a measured latency."
      },
      {
        "region_ids": [
          "thalamus"
        ...
        "evidence_tier": "estimated",
        "tier_reason": "Schematic: human spindle-memory correlations are real, but this spacing is not time."
      },
      {
        "region_ids": [
          "hippocampus"
        ...
        "evidence_tier": "estimated",
        "tier_reason": "Schematic: replay established in rodents, with converging human intracranial evidence."
      },
      {
        "region_ids": [
          "hippocampus",
        ...
        "evidence_tier": "estimated",
        "tier_reason": "Schematic: human coupling evidence (Staresina et al., 2015), but no elapsed time."
      },
      {
        "region_ids": [
          "dlpfc",
        ...
        "evidence_tier": "estimated",
        "tier_reason": "Schematic: systems consolidation runs over nights and years, not milliseconds."
      }
    ],
